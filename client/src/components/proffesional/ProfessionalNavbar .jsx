...
const ProfessionalNavbar = () => {
    ...
    const [logOutAdmin, { isSuccess, isError, isLoading, error }] = useLogOutAdminMutation()
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="flex-shrink-0 text-2xl font-bold text-blue-500">
                        Professionl's DashBoard
                    </div>
                    {/* Links */}
                    <div className="hidden md:flex space-x-8">
                        <Link to="/professional/professional-profile" className={getLinkClasses("/professional/professional-profile")}>
